...
public class DataGetHandler implements HttpHandler {
    ...
    static String apibHost = cluster.serviceToUrl("https", "com.networknt.apib-1.0.0", tag, null);;
    static String apicHost = cluster.serviceToUrl("https", "com.networknt.apic-1.0.0", tag, null);
   ...
   public ClientConnection getConnection(String URI) throws Exception {
    ...
    public DataGetHandler() {
        try {
            ...
            connectionC = getConnection(apicHost);
        } catch (Exception e) {
